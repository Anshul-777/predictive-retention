...
# 6. Create a helper function, e.g., preprocess_input(customer_data: CustomerData) -> pd.DataFrame:
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://localhost:3000", "https://customer-churn-predictor-eta.vercel.app"], # <--- UPDATED Vercel frontend URL here
